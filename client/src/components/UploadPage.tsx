...
export default function UploadPage() {
    ...
    if (code) {
        return (
            ...
            >
                ...
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-800 max-w-md mx-auto relative overflow-hidden">
                    <div className="text-sm font-medium text-gray-400 mb-2 uppercase tracking-wider">Share Code</div>
                    <div className="text-5xl font-mono font-bold text-black dark:text-white tracking-widest mb-6">{code}</div>
    ...
    return (
        ...
        >
            ...
            <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl shadow-2xl border border-gray-100 dark:border-zinc-800 relative transition-colors duration-300">
                {!file ? (
                    <div
                        {...getRootProps()}
                        className={cn(
                            "border-4 border-dashed rounded-2xl p-12 text-center cursor-pointer transition-all duration-300 group",
                            isDragActive
                    ...
                    >
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="w-24 h-24 bg-gray-100 dark:bg-zinc-800 rounded-full flex items-center justify-center text-black dark:text-white group-hover:scale-110 transition-transform duration-300">
                                <UploadCloud size={48} />
                            </div>
                        </div>
